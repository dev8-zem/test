...
Процедура ПередЗаписью(Отказ)
	...
	Если ДвоичныеДанные <> Неопределено Тогда
		Если Не Справочники.МашиночитаемыеДоверенностиОрганизаций.ЭтоПередоверие(ДвоичныеДанные) Тогда
...
Процедура ЗаписатьВЖурнал(Отказ) Экспорт
	...
	СведенияФайла = МашиночитаемыеДоверенности.ДанныеИзФайлаОбмена(ДанныеДоверенности).ДанныеМЧД;
