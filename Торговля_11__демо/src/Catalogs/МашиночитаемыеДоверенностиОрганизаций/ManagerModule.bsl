...
// Возращает сведения о представителе 
...
//
// Параметры:
//  ДвоичныеДанные - ДвоичныеДанные - Хранимые в реквизите "XMLфайлМЧД" доверенности
//
// Возвращаемое значение:
//  Булево - Признак того что является или нет передоверием
//
Функция ЭтоПередоверие(ДвоичныеДанные) Экспорт
