...
Функция ЗагрузитьМЧДИзФайла(ДанныеФайла, МЧД = Неопределено, ДополнительныеСведения = Неопределено) Экспорт
	...
	Если Данные.Свойство("ДанныеМЧД") Тогда
		ДанныеДляПроверки.ДанныеДоверенности = Данные.ДанныеМЧД;
	Иначе
		ДанныеДляПроверки.ДанныеДоверенности = Данные.ДанныеДоверенности;
	КонецЕсли;
	Если Данные.Свойство("ДанныеПодписи") И ЗначениеЗаполнено(Данные.ДанныеПодписи) Тогда
		ДанныеДляПроверки.ДанныеПодписи = Данные.ДанныеПодписи;
	ИначеЕсли Данные.Свойство("Подписи") И ЗначениеЗаполнено(Данные.Подписи) Тогда
		ДанныеДляПроверки.ДанныеПодписи = Данные.Подписи[0];
	КонецЕсли;
	...
	ИначеЕсли Данные.Свойство("Подписи") И ЗначениеЗаполнено(Данные.Подписи) Тогда
		ДанныеДляЗагрузки.ДанныеПодписи = Данные.Подписи[0];
	КонецЕсли;
