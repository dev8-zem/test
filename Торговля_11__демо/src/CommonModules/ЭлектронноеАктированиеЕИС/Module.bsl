...
Процедура ПроверитьОснованиеОтгрузкиТоваров(ДеревоДанных) Экспорт
	...
	ОснованияОтгрузкиТоваров = ДеревоДанных.Строки.Найти("ОснованиеОтгрузкиТоваров", "ПолныйПуть");
	Для каждого Основание Из ОснованияОтгрузкиТоваров.Строки Цикл
		
		ДокументНаименование = ДеревоЭлектронногоДокументаБЭД.ЗначениеРеквизитаВДереве(Основание,
			"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументНаименование");
		ДокументДата = ДеревоЭлектронногоДокументаБЭД.ЗначениеРеквизитаВДереве(Основание,
			"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументДата");
		ДокументНомер = ДеревоЭлектронногоДокументаБЭД.ЗначениеРеквизитаВДереве(Основание,
			"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументНомер");
		ДокументДопСведения = ДеревоЭлектронногоДокументаБЭД.ЗначениеРеквизитаВДереве(Основание,
			"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументДопСведения");
			
		// ДокументНаименование, атрибут НаимОсн.
		ДокументНаименование = НСтр("ru = 'Контракт'");
		Если НЕ ДанныеКонтракта.Номер = ДокументНаименование Тогда
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Основание,
				"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументНаименование",
				ДокументНаименование);
		КонецЕсли;
		
		// ДокументНомер, атрибут НомОсн.
		Если НЕ ДанныеКонтракта.Номер = ДокументНомер Тогда
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Основание,
				"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументНомер",
				ДанныеКонтракта.Номер);
		КонецЕсли;
		
		// ДокументДата, атрибут ДатаОсн.
		Если НЕ ДанныеКонтракта.ДатаЗаключенияКонтракта = ДокументДата Тогда
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Основание,
				"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументДата",
				ДанныеКонтракта.ДатаЗаключенияКонтракта);
		КонецЕсли;
		...
		Если НЕ ДополнительныеСведения = ДокументДопСведения Тогда
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Основание,
				"ОснованиеОтгрузкиТоваров.НомерСтроки.ДокументДопСведения",
