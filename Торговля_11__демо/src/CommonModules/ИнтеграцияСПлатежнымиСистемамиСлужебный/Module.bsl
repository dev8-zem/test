...
Функция НастройкиУчастникаСБП(Идентификатор) Экспорт
	...
	Запрос.Текст = 
		...
		|	ИдентификаторыУчастниковСБП.Наименование КАК Наименование,
		|	ИдентификаторыУчастниковСБП.ПодключениеКассовойСсылки КАК ПодключениеКассовойСсылки
		|ИЗ
		|	РегистрСведений.ИдентификаторыУчастниковСБП КАК ИдентификаторыУчастниковСБП
		|ГДЕ
...
Процедура ЗаписатьНастройкиУчастниковСБП(Настройки) Экспорт
	...
	Для Каждого Настройка Из Настройки Цикл
		...
		ЗаписьИдентификаторы.ПодключениеКассовойСсылки = Настройка.c2bCashRegisterReservedQrIdSupported;
...
//   * ПартнераАгентаСБП - Булево - признак подключения банка партнера Агента ТСП.
//
Функция НовыйПараметрПодсказки() Экспорт
	...
	ПараметрыПодсказки.Вставить("ПартнераАгентаСБП", Ложь);
