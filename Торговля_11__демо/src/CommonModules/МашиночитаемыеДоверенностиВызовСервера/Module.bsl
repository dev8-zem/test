...
// См. МашиночитаемыеДоверенности.НовыеДанныеДляЗагрузкиМЧД
Функция НовыеДанныеДляЗагрузкиМЧД() Экспорт
	
	Возврат МашиночитаемыеДоверенности.НовыеДанныеДляЗагрузкиМЧД();
...
Функция ДатаОтзываДоверенности(НомерДоверенности, ДоверительЮЛ_ИНН, ДоверительФЛ_ИНН, ТокенДоступа) Экспорт
	...
	Возврат МашиночитаемыеДоверенности.ДатаОтзываДоверенности(НомерДоверенности,
