...
// Изменение использования регламентного задания работает в коробках и режиме сервиса.
//
// Параметры:
//  Идентификатор - ОбъектМетаданныхРегламентноеЗадание - метаданные регламентного задания.
...
Процедура УстановитьИспользованиеРегламентногоЗадания(Идентификатор, Использование) Экспорт
	...
	ПараметрыПоиска.Вставить("Метаданные", Идентификатор);
	...
	Если РегламентноеЗадание.Использование = Использование Тогда
		Возврат;
	КонецЕсли;
