...
Процедура ЗагрузитьТоварыВДеревоЦен(Форма, ВыборкаНоменклатура, КэшДанных)
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		Если ТипЗнч(ЭлементНоменклатура) = Тип("Структура")
				...
				Или ТипЗнч(ЭлементНоменклатура) = Тип("СтрокаДереваЗначений")
				И Форма.ДеревоЦен.Колонки.Найти("УстановкаУсловий" + ИмяКолонки) <> Неопределено Тогда
		...
		Если ЭтоРегистрацияЦенПоставщика Тогда
			...
			Если Форма.ИспользоватьУпаковкиНоменклатуры Тогда
				...
				Если ТипЗнч(ЭлементНоменклатура) = Тип("Структура")
						...
						Или ТипЗнч(ЭлементНоменклатура) = Тип("СтрокаДереваЗначений")
						И Форма.ДеревоЦен.Колонки.Найти("УпаковкаЗаказа" + ИмяКолонки) <> Неопределено Тогда
			...
			Если ТипЗнч(ЭлементНоменклатура) = Тип("Структура")
					...
					Или ТипЗнч(ЭлементНоменклатура) = Тип("СтрокаДереваЗначений")
					И Форма.ДеревоЦен.Колонки.Найти("МинимальнаяПартияПоставки" + ИмяКолонки) <> Неопределено Тогда
