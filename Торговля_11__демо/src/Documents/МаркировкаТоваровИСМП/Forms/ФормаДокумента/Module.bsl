...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ДатаПроизводства.АвтоОтметкаНезаполненного =
		ДляВидаПродукцииИспользуетсяДатаПроизводства И (ЭтоОперацияНанесения Или ЗначениеЗаполнено(ОперацияНанесения))
		Или Не (ЭтоШины Или ДляВидаПродукцииИспользуетсяДатаПроизводства) И (ЭтоПроизводствоРФ Или ЭтоКонтрактноеПроизводство)
