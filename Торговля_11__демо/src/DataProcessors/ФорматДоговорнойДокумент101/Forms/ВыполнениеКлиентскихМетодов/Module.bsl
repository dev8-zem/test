...
&НаСервере
Перем ОбработкаЗначение; // ОбработкаОбъект.ФорматДоговорнойДокумент101
...
//   * ПечатнаяФорма      - Булево - файл подготовливается путем формирования и преобразования печатной формы.
//
&НаКлиенте
